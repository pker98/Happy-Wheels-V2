...
class Orders_repo(object):
    ...
    def update_order_file(self, order_dict):
        ...
        with open("data/Orders.csv", "w+") as Order_file:
            Order_file.write("order_num,pick_up_date,drop_off_date,plate_num,cust_email\n")
            for plate_num, values in order_dict.items():
                for order in values:
                    ...
                    Order_file.write("{},{},{},{},{}\n".format(order_num,pick_up_date,drop_off_date,plate_num,cust_email))
    ...
    def get_orders(self):
        with open("./data/Orders.csv", "r") as Order_file:
            ...
            for line in csv_reader:
                order_num,pick_up_date,drop_off_date,plate_num,cust_email = line
